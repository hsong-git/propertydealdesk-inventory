...
export function AdminLandingPage() {
  ...
  if (!state.authenticated) return <main className="page-width page-state"><Seo title="Administrator access | HS Ong Property Inventory" /><a className="button primary" href="/api/admin/session">Sign in with Cloudflare</a></main>;
