...
export function ContactPage() {
  ...
  return (
    <main className="page-width content-page">
      <Seo
        title="Contact HS Ong | Property Enquiries"
        description="Contact HS Ong for public property listings, co-broke enquiries, viewing arrangements and Klang or Shah Alam property discussions."
        canonical={`${SITE_ORIGIN}/contact`}
        ogTitle="Contact HS Ong"
      />
