...
export function AdminLandingPage() {
  ...
  if (!state.authenticated) return <main className="page-width page-state"><Seo title="Administrator access required | HS Ong Property Inventory" /><strong>Administrator access required</strong><p>This private administration area is not available to public visitors.</p><Link className="button secondary" to="/">Back to Catalogue</Link></main>;
